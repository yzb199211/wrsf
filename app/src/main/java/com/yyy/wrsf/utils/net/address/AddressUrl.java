...
public class AddressUrl {
    ...
    public final static String getAddressSendList = " /memberSendadd/getMemberSendaddPageList";
    public final static String AddAddress = "/memberRecadd/insertRecadd";
    public final static String AddAddressSend = "/memberSendadd/insertSendadd";
    public final static String updateAddress = "/memberRecadd/updateRecadd";
    public final static String updateAddressSend = "/memberSendadd/updateSendadd";
    public final static String deleteAddress = "/memberRecadd/deleteRecadd";
    public final static String deleteAddressSend = "/memberSendadd/deleteSendadd";
}
