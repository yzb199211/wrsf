...
public class OrderNoticeAdapter extends RecyclerView.Adapter<OrderNoticeAdapter.VH> {
...
//        holder.tvCompany.setText(list.get(position));
        ...
        holder.tvPay.setText(context.getString(R.string.order_wait_notice_yes));
