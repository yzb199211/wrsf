...
public class OrderSearchActivity extends BaseActivity implements XRecyclerView.LoadingListener, IOrderV {
    ...
    private OrderAdapter initAdapter() {
        adapter = new OrderAdapter(OrderSearchActivity.this, orders);
