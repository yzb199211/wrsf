...
public class OrderNoticeActivity extends BaseActivity implements XRecyclerView.LoadingListener, IOrderV {
    ...
    private OrderNoticeAdapter initAdapter() {
        adapter = new OrderNoticeAdapter(OrderNoticeActivity.this, orders);
...
//            orderP.cancel(pos, orders.get(pos).getContractNo());
    ...
    private void go2Pay(int pos) {
        orderP.notice(pos, orders.get(pos).getContractNo());
    }
