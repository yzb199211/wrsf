...
public class BillMonthDetailAdapter extends RecyclerView.Adapter<BillMonthDetailAdapter.VH> {
    private Context context;
    private List<CompanyBillDetailB> list;
    private OnItemClickListener onItemClickListener;

    public BillMonthDetailAdapter(Context context, List<CompanyBillDetailB> list) {
    ...
    public void onBindViewHolder(@NonNull VH holder, int position) {
        ...
        holder.tvUnpaid.setText(context.getString(R.string.bill_unpay) + ":" + context.getString(R.string.common_rmb) + list.get(position).getUnpaid());
        holder.tvTotal.setText(context.getString(R.string.bill_total) + ":" + context.getString(R.string.common_rmb) + list.get(position).getContractTotal());
