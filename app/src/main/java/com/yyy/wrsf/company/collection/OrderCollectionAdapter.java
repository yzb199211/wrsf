...
public class OrderCollectionAdapter extends RecyclerView.Adapter<OrderCollectionAdapter.VH> {
    ...
    public OrderCollectionAdapter(Context context, List<OrderBean> list) {
...
//        holder.tvCompany.setText(list.get(position));
        ...
        holder.tvOrderCost.setText(context.getString(R.string.main_pending_payment) + "：¥" + list.get(position).getDaiTotal());
